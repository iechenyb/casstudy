...
<body>
sesssionId:<%=request.getSession().getId()%>
...
<a href="<%=basePath%>logout?service=<%=basePath%>user/infor">退出</a><br>
	...
	<table border="1" width="50%">
		...
		<tbody>
			<tr>
				<td>购物车系统</td>
				<td><a target="_blank" href="http://cart.kiiik.com:8081/cart/index">购物车系统入口</a></td>
			</tr>
			<tr>
				<td>订单系统</td>
				<td><a target="_blank" href="http://order.kiiik.com:8082/order/index">订单系统入口</a></td>
			</tr>
			<tr>
				<td>库存系统</td>
				<td> <a target="_blank" href="http://stock.kiiik.cn:8083/stock/index">库存系统入口</a></td>
			</tr>
			<!-- <tr>
				<td>中央认证服务</td>
