...
public class Client {
    ...
    public static void main(final String[] args) throws Exception {
        final String server = "http://localhost:8088/cas/v1/tickets";
        final String username = "cj";
        final String password = "cj";
        final String service = "http://localhost:8088";
        final String proxyValidate = "http://localhost:8088/cas/proxyValidate";
