        ...
        <div class="login_box">
            <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
                <div class="w261">
                    ...
                    <!-- 新增系统类型 -->
					<div class="user">
                        <spring:message code="screen.welcome.label.system.accesskey" var="systemAccessKey" />
                        <form:input cssClass="input_box" placeholder="请输入系统名称"  id="system" size="25" tabindex="2" path="system"  accesskey="${systemAccessKey}" htmlEscape="true" autocomplete="off" />
                    </div>
                    ...
                    <input type="hidden" name="lt" value="${loginTicket}"/><!-- name="lt"  -->
